<html>
	...
	marginwidth="0" leftmargin="0" hspace="0">
		<center>
			...
			//echo "<br>url=\"http://www.VMARchurches.com/newcontent2.php?safefile=" . $SafeFile . "\"";
			...
			if ($_REQUEST["option"] == "CL") {
				...
				echo "<meta http-equiv=REFRESH content=0;url=\"http://www.vmarchurches.com/newcontent2.php?safefile=" . $SafeFile . "&safefile2=" . $SafeFile2 . "\">";
			}
