...
<body style='margin:0; font-family:Arial;' >
	...
	<!-- <div class="container" style="font-size: Large; background-color: white;  "> -->
		...
		$q2 = "Select * from UtilityVerificationApplication 
		Where UtilityVerificationApplication.PermitId = " . $_GET["Id"] ;
			
		$r2 = mysqli_query($connection2, $q2) or die("<br/>Query failed 92 : " . $q2);
		$First = True;
		While ($row2 = mysqli_fetch_array($r2)) {
			$edit = true;			
			$UVAId = $row2["Id"];
			if (!$First) {echo '<br style="page-break-before: always">';}
			$First = False;
		?>
...
&nbsp;&nbsp;&nbsp;(757)&nbsp;385-4171
		...
		<td  style="text-align:left; font-size: medium; font-weight: bold">
			&nbsp;<p>
				Install Date: <u><b><?php echo DisplayDate($row2["UVADate"]); ?> </b></u><br>
				Sketch Sheet: <u><b><?php echo $row2["SketchSheet"]; ?> </b></u>
		</td>
	</tr>
	</table>
	<table width='100%' border='0' cellspacing='0' style='font-family:Arial;'>	
	...
	<tr>
		<td  >
			<b>Location/Address: <u><?php echo $row2["LocationAddress"]; ?> </u></b>
		</td>
	</tr>	
	<tr>
		<td  >
			<b>Street name of utility crossing: <u><?php echo $row2["StreetName"]; ?> </u></b>
		</td>
	</tr>		
	...
	<tr>
		<td  >
			<b>Company: <u><?php echo $row2["Company"]; ?> </u></b>
		</td>
	</tr>
	...
	<tr>
		<td  >
			<b>Subcontractor: <u><?php echo $row2["Subcontractor"]; ?> </u></b>
		</td>
	</tr>
	...
	<tr>
		<td  >
			<b>Foreman / Supervisor on-site: <u><?php echo $row2["Foreman"]; ?> </u></b>
		</td>
	</tr>
	...
	<tr>
		<td  >
			<b>Technician / Inspector: <u><?php echo $row2["Technician"]; ?> </u></b>
		</td>
	</tr>
	...
	<tr>
		<td  >
			<b>PU Technician Comments: <u><?php echo $row2["tComments"]; ?> </u></b>
		</td>
	</tr>
	...
	<tr>
		<td  >
			<b>Verified: <u><?php 
			if (isset($row2["Verified"]) && trim($row2["Verified"]) <> "select") {echo $row2["Verified"];} ?> </u></b>
		</td>
	</tr>
</table>
<table width='100%' border='0' cellspacing='0' style='font-family:Arial;'>	
		...
		<?php
			...
			Where UtilityVerificationApplication.Id = " . $UVAId . " and 
