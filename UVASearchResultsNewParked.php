	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				...
				PIP.Technician, SketchSheet, Subcontractor, Foreman, CompanyName  
				...
				if ($_POST["chkOpenPermit"] == "on") {
					$strSQL = $strSQL . " and  (PermitClosed is Null or PermitClosed = 'False') ";
					echo " Open Permit";
				}

				if ($_POST["ConstructionStart"] == "on") {
				...
				while ($row = mysqli_fetch_array($result)) {
					...
					if ($CurrentPermitId <> $row[2] || 1 == 1 ) {
						...
						<th style="text-align:center;">Foreman</th></tr>';
						...
						echo "<td align=center valign=top>" . $row[8] . "</td>";
						echo "</tr></tr>";
