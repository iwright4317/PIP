...
<body>
	...
	<form action=store_DNOFemails.php method="post">
	...
	<div class="col-md-12" style="font-size: x-large; font-weight: bold;">
		PIP - Edit Daily Notification Online Form Email list.
	</div>
	</div>
	...
	<div class="row">
		<div class="col-md-12">
			...
			<?php
			$q = "Select EMails from DNOFemails";
			$r = mysqli_query($connection, $q) or die("<br/>Query failed<br>" . $q . "<br>" . mysqli_error($connection));
			if ($row = mysqli_fetch_array($r)) {
				echo '<textarea name=emails rows="4" cols="100">' . $row[0] . '</textarea>';
				
			} else {
				echo '<textarea name=emails rows="4" cols="100">no emails found</textarea>';
			}	
